...
# Rect објекти за новите копчиња
PURPLERECT = pygame.Rect(
    XMARGIN - BUTTONSIZE - BUTTONGAPSIZE, YMARGIN, BUTTONSIZE, BUTTONSIZE
)
ORANGERECT = pygame.Rect(
    XMARGIN + (BUTTONSIZE + BUTTONGAPSIZE) * 2, YMARGIN, BUTTONSIZE, BUTTONSIZE
)


# сите можни бои
BUTTONCOLORS = [YELLOW, BLUE, RED, GREEN, PURPLE, ORANGE]


# нова променлива за броење на итерација
patternSize = 1


def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, BEEP1, BEEP2, BEEP3, BEEP4, patternSize, FLASHSPEED
    ...
    while True:  # main game loop
        ...
        if not waitingForInput:
            # намалување на flash speed за да се зголеми тежината на играта во покасните фази
            if score > 5:
                FLASHSPEED = 400
            elif score > 10:
                FLASHSPEED = 300
            ...
            # експоненцијално додавање на нови бои во патернот
            for _ in range(patternSize):
                pattern.append(random.choice(BUTTONCOLORS))
...
def getButtonClicked(x, y):
    if YELLOWRECT.collidepoint((x, y)):
        ...
        return GREEN
    # додавање на случаи за новите копчиња
