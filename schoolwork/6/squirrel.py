...
# изменети се вредностите за побрзо движење и поспоро скокање
...
# зголемено е времето на invulnerability
...
def runGame():
    ...
    while True:  # main game loop
        ...
        # место секој втор tick, има flashing секој петти tick
        flashIsOn = round(time.time(), 1) * 10 % 5 == 4
