...
import time  # нова библиотека

# Create the constants (go ahead and experiment with different values)
BOARDWIDTH = 4  # number of columns in the board
BOARDHEIGHT = 4  # number of rows in the board
TILESIZE = 90  # зголемени се коцките
WINDOWWIDTH = 720  # зголемена е ширината на прозорот
WINDOWHEIGHT = 540  # зголемена е висината на прозорот
FPS = 30
BLANK = None
...
# функција за генерирање на рандом броеви
...
def main():
    ...
    while True:  # main game loop
        ...
        msg = "Click tile or press arrow keys to slide. Moves: " + str(
            moveCounter
            ...
            if event.type == MOUSEBUTTONUP:
                ...
                if (spotx, spoty) == (None, None):
                    ...
                    if RESET_RECT.collidepoint(event.pos):
                        ...
                        mainBoard, solutionSeq = generateNewPuzzle(
                            get_random_number()  # рандом место фиксен број
        ...
        if slideTo:
            ...
            moveCounter += 1  # зголемен е бројот на потези
