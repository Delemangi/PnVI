...
# бројач за редови потребни за качување на ниво
SCORE_REQ = 10
...
# додавање на нова фигура
B_SHAPE_TEMPLATE = [[".....", ".OOO.", ".OOO.", ".OOO.", "....."]]
...
PIECES = {
    ...
    "O": O_SHAPE_TEMPLATE,
    "T": T_SHAPE_TEMPLATE,
    # додавање на нова фигура во речникот од сите фигури
    "B": B_SHAPE_TEMPLATE,
}
...
def calculateLevelAndFallFreq(score):
    ...
    # проверка за качување на потребни редови
    if level != int(max(0, (score - 1)) / SCORE_REQ) + 1:
        SCORE_REQ += 2
    # поспоро ажурирање на ратата на паѓање
