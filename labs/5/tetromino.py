...
# зголемување на прозорот на играта
WINDOWWIDTH = 640
WINDOWHEIGHT = 1000

BOXSIZE = 20

# зголемување на бројот на квадрати во таблата
BOARDWIDTH = 20
BOARDHEIGHT = 40
...
# број на поени за качување на ниво
SCORE_REQ = 10
    ...
    while True:  # game loop
        ...
        if time.time() - lastFallTime > fallFreq:
            ...
            if not isValidPosition(board, fallingPiece, adjY=1):
                ...
                # калкулирање на комплетираните редови
                removedLines = removeCompleteLines(board)
                score += removedLines
                # ратата на паѓање сега зависи и од комплетираните редови
...
def calculateLevelAndFallFreq(score, change):
    ...
    # логика за калкулирање на ниво
    scoreCounter = score
    level = 1

    # корисникот качил ниво
    ...
    # логика за калкулирање на ратата на паѓање
