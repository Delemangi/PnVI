...
# додадени се променливи за копчето за помош
helpMode = False
HELP_TEXT = "Click tile or press arrow keys to slide."
RED = (255, 0, 0)

# додадени се променливи за blankxpos и blankypos
blankxpos = BOARDWIDTH - 1  # Initial position of the blank tile
blankypos = BOARDHEIGHT - 1


# функција за обојување на соседните полиња
def highlightAdjacentFields(board):
...
def getBlankPosition(board):
    ...
    # се враќаат променливите кои се чуваат
    return (blankxpos, blankypos)


# изменета е функцијата да се користат глобалните променливи
def makeMove(board, move):
    global blankxpos, blankypos
    # This function does not check if the move is valid.

    # соодветно во сите случаи се ажурираат координатите на празното поле
    if move == UP:
...
def drawBoard(board, message):
    ...
    DISPLAYSURF.blit(HELP_SURF, HELP_RECT)  # рендерирање на новото копче
